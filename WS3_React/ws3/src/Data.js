...
export const funcionJson=[
    {'logo':'logo1.png','titulo':'Director comercial','habilidad': ['Business Analysis','Commercial Relationship','Commercial Strategy'], 'nombre':'Confidencial', 'ubicacion': 'Bucaramanga', 'salario': 'Confidencial', 'disponible':'1','beneficios':['certificados','fiesta','capacitaciones']},
    ...
    {'logo':'logo1.png','titulo':'Ingeniero de datos','habilidad': ['Bi','Etl','Python'], 'nombre':'Direktio', 'ubicacion': 'Remoto Colombia', 'salario': '3.5M', 'disponible':'1','beneficios':['Trabajo remoto','Horario flexible','Leccion en programacion','Celebracion de dias especiales','Ambiente trabajo amigable','Dia completo o medio dia libre de cumpleaños']},
     
    {'logo':'logo1.png','titulo':'Grow Manager','habilidad': ['Negotiation Skill','Project Management','Lead Work Teams'], 'nombre':'Vichara Techologies/Tech Labs...', 'ubicacion': 'Hibrido-mix remoto y presencial...', 'salario': 'Confidencial', 'disponible':'1','beneficios':['Seguro medico privado','Horario flexible','Trabajo remoto parcial','Celebracion de dias especiales','Ambiente trabajo amigable','Capacitaciones']}
     
    ,{'logo':'logo1.png','titulo':'Ejecutivo comercial senior, en MetLife','habilidad': ['Commercial Aggressiveness','Negotiating Capacity.'], 'nombre':'Metlife Medellin', 'ubicacion': 'Medellin', 'salario': '2.9M-6M', 'disponible':'1','beneficios':['']},
     
    {'logo':'logo1.png','titulo':'Analista de calidad','habilidad': ['QA','Quality Audit','Process Quality'], 'nombre':'OFFIMEDICAS S.A', 'ubicacion': 'Bucaramanga', 'salario': '1.5M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']}
     
    ,{'logo':'logo1.png','titulo':'Coordinador de Calidad','habilidad': ['QA','Quality Audit','Proccess Quality'], 'nombre':'OFFIMEDICAS S.A', 'ubicacion': 'Bucaramanga', 'salario': '2.5M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']},
     
    {'logo':'logo1.png','titulo':'Ingeniero de calidad','habilidad': ['QA','Quality Audit'], 'nombre':'OFFIMEDICAS S.A', 'ubicacion': 'Bucaramanga', 'salario': '2M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']}
     
    ,{'logo':'logo1.png','titulo':'Director de infraestructuras TI','habilidad': ['Project Management','Complianece With Indicators','Liderazgo'], 'nombre':'Confidencial', 'ubicacion': 'Bucaramanga', 'salario': '5M-7M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']},
    ...
    ,{'logo':'logo1.png','titulo':'Tester de Software','habilidad': ['Resolution Capacity','Complianece With Indicators','Agile Work'], 'nombre':'OFFIMEDICAS S.A', 'ubicacion': 'Presencial(Bucaramanga)', 'salario': '2.8M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']},
     
    {'logo':'logo1.png','titulo':'Desarollo de software','habilidad': ['Resolucion capacity','Adaptation to Changes'], 'nombre':'OFFIMEDICAS S.A', 'ubicacion': 'Bucaramanga', 'salario': '2.8M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']}
    ...
    {'logo':'logo1.png','titulo':'Quimico Farmaceutico','habilidad': ['Capacidad De Analisis','Process Improvent','Liderazgo'], 'nombre':'Confidecial', 'ubicacion': 'Bucaramanga', 'salario': '5M-7M', 'disponible':'1','beneficios':['Certificado','Fiesta de Fin de año','Capacitaciones']}
