...
const Nominad = () => {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const info_api = await nomina_user({ "id_usuario": usuarioID })
      setData(info_api.data);
  ...
  if (data) {
    ...
    /*
        for (let index = 0; index < data.length; index++) {
          let d = 0;
          if (data[index].mes.toLowerCase() == "octubre") {
            d = 10;
          } else if (data[index].mes.toLowerCase() == "enero") {
            d = 1;
          } else if (data[index].mes.toLowerCase() == "septiembre") {
            d = 9;
          } else if (data[index].mes.toLowerCase() == "febrero") {
            d = 2;
          } else if (data[index].mes.toLowerCase() == "marzo") {
            d = 3;
          } else if (data[index].mes.toLowerCase() == "abril") {
            d = 4;
          } else if (data[index].mes.toLowerCase() == "mayo") {
            d = 5;
          } else if (data[index].mes.toLowerCase() == "junio") {
            d = 6;
          } else if (data[index].mes.toLowerCase() == "julio") {
            d = 7;
          } else if (data[index].mes.toLowerCase() == "agosto") {
            d = 8;
          } else if (data[index].mes.toLowerCase() == "noviembre") {
            d = 11;
          } else if (data[index].mes.toLowerCase() == "diciembre") {
            d = 12;
          }
          data[index].mesn = d;
            ...
            <table className=" text-left border-collapse" style={{ width: "85%" }}>
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border-b p-4" onClick={() => requestSort('mes')} style={{ cursor: "pointer" }}>Mes {sortConfig.key === 'mes' ? (sortConfig.direction === 'ascending' ? '↑' : '↓') : '↕'}</th>
